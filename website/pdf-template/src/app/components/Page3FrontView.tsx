...
export function Page3FrontView() {
  ...
  return (
    <InspectionPage pageNumber={3}>
      <h2 className="section-header-bilingual">Vehicle Front Image / वाहन का अगला दृश्य</h2>
      ...
      <div className="image-detail-layout">
        ...
        <div className="detail-card compact-card">
          ...
          <div className="detail-item-compact">
            <span className="detail-label">Paint Depth Reading / पेंट गहराई रीडिंग</span>
            <span className="detail-value">{data.front.bumper_paint_depth}</span>
          </div>
          <div className="detail-item-compact">
            <span className="detail-label">Is Front Bumper Repainted? / क्या फ्रंट बंपर दोबारा रंगा गया?</span>
            <span className="detail-value">{data.front.bumper_repainted}</span>
          </div>
          <div className="detail-item-compact">
            <span className="detail-label">Bonnet Condition / बोनट स्थिति</span>
            <span className="detail-value">{data.front.bonnet_condition}</span>
          </div>
          <div className="detail-item-compact">
            <span className="detail-label">Bonnet Paint Depth / बोनट पेंट गहराई</span>
            <span className="detail-value">{data.front.bonnet_paint_depth}</span>
          </div>
          <div className="detail-item-compact">
            <span className="detail-label">Is Bonnet Repainted? / क्या बोनट दोबारा रंगा गया?</span>
            <span className="detail-value">{data.front.bonnet_repainted}</span>
          </div>
          <div className="detail-item-compact">
            <span className="detail-label">Is Bonnet Company Fitted? / क्या बोनट कंपनी फिटेड है?</span>
      ...
      <div className="detail-card">
        <div className="detail-grid-four">
          <div className="detail-item">
            <span className="detail-label">Front Grille Condition / फ्रंट ग्रिल स्थिति</span>
            <span className="detail-value">{data.front.grill_condition}</span>
          </div>
          <div className="detail-item">
            <span className="detail-label">Windshield Original / विंडशील्ड मूल</span>
            <span className="detail-value">{data.front.windshield_original}</span>
          </div>
          <div className="detail-item">
            <span className="detail-label">Windshield Condition / विंडशील्ड स्थिति</span>
            <span className="detail-value">{data.front.windshield_condition}</span>
          </div>
          <div className="detail-item">
            <span className="detail-label">Headlight Condition / हेडलाइट स्थिति</span>

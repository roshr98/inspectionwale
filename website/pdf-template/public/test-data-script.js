// TEST DATA PREFILL SCRIPT
// Copy and paste this entire script into your browser's console to prefill the inspection form with test data
...
function clearInspectionForm() {
  try {
    ...
    console.log('📋 Reload the page to see the empty form.');
    return true;
  } catch (error) {
...
║  Available Commands:                                           ║
║                                                                ║
║  1. prefillInspectionForm()                                    ║
║     → Loads complete test data into the form                   ║
║                                                                ║
║  2. clearInspectionForm()                                      ║
║     → Clears all form data from cache                          ║
║                                                                ║
║  3. viewInspectionData()                                       ║
║     → View current data stored in cache                        ║
║                                                                ║
║  Usage:                                                        ║
║  1. Run: prefillInspectionForm()                               ║
║  2. Reload the page to see prefilled form                      ║
║                                                                ║
╚════════════════════════════════════════════════════════════════╝
`);

// Auto-run prefill if URL has ?prefill=true
if (window.location.search.includes('prefill=true')) {
  console.log('🚀 Auto-prefilling form data...');
